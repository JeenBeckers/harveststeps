...
/**
 * One-time bulk import list, cleaned per Jeen's review (2026-08-10):
 * placeholder/non-name rows dropped, ABN -> ABN AMRO, Essent 1/2/3 -> Essent,
 * Liesbeth's start moved to 1 sep 2026, all start years normalized to 2026
 * (the sheet's later years were the 1-year-program end date, not the start),
 * Clinton Emok's client corrected to "Nog te matchen".
 */
export const IMPORT_HARVESTERS: ImportRow[] = [
  { id: "imp-lucasdobbelsteen", name: "Lucas Dobbelsteen", client: "Essent", start: "1 sep 2026" },
  ...
  { id: "imp-raulmihalca", name: "Raul Mihalca", client: "Dela", start: "1 mei 2026" },
  { id: "imp-nielslazaroms", name: "Niels Lazaroms", client: "Essent", start: "1 mei 2026" },
  { id: "imp-alexfrancis", name: "Alex Francis", client: "ABN AMRO", start: "1 mei 2026" },
  ...
  { id: "imp-dinabellouki", name: "Dina Bellouki", client: "ABN AMRO", start: "30 jun 2026" },
  { id: "imp-sophia", name: "Sophia van Lieshout", client: "ABN AMRO", start: "1 jul 2026" },
  { id: "imp-milakasteel", name: "Mila Kasteel", client: "ABN AMRO", start: "27 jul 2026" },
  { id: "imp-finolaparkinson", name: "Finola Parkinson", client: "ABN AMRO", start: "27 jul 2026" },
  { id: "imp-liesbethoogh", name: "Liesbeth Oogh", client: "ABN AMRO", start: "1 sep 2026" },
  { id: "imp-sahar", name: "Sahar Marosi", client: "ABN AMRO", start: "1 sep 2026" },
  { id: "imp-muna", name: "Muna Mahamed", client: "ABN AMRO", start: "1 sep 2026" },
  ...
  { id: "imp-clintonemok", name: "Clinton Emok", client: "Nog te matchen", start: "1 sep 2026" },
  { id: "imp-jeroenpullen", name: "Jeroen Pullen", client: "Nog te matchen", start: "1 okt 2026" },
  { id: "imp-michaelmoor", name: "Michael de Moor", client: "BBTG", start: "1 okt 2026" },
];
