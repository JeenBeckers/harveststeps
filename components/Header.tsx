...
export function Header({ harvestPlannerLabels }: { harvestPlannerLabels: boolean }) {
  ...
  return (
    <header className="hv-header">
      <div className="hv-header__brand">
        ...
        <span className="hv-eyebrow hv-header__section">{sectionLabel(harvestPlannerLabels)}</span>
      </div>
      ...
      <div className="hv-header__meta">
        <span className="hv-eyebrow hv-header__metatext">{activeCountLabel(activeJourneys, harvestPlannerLabels)}</span>
